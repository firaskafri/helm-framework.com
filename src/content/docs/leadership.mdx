...
**Critical reminder:** A team's effective level is set by its least-adopted member in a critical-path role — see the [Maturity Assessment](/practitioners#maturity-assessment-quick-reference) in the Practitioner Guide for the full rationale.
